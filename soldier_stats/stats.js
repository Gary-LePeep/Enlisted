const SOLDIER_STATS = [
  ...
  [
    ...
    {
      Name: 'class_Assaulter#I',
      Stats: [6, 4, 5],
      Talent: '+35% climbing speed',
    },
    {
      Name: 'class_Assaulter#II',
      Stats: [7, 5, 6],
      Talent: '+35% stamina',
    },
    {
      Name: 'class_Assaulter#III',
      Stats: [8, 6, 7],
  ...
  [
    {
      Name: 'class_ATGunner#I',
      Stats: [2, 6, 7],
      Talent: '+52.5% speed of changing pose',
    },
    {
      Name: 'class_ATGunner#II',
      Stats: [2, 8, 8],
  ...
  [
    {
      Name: 'class_Machinegunner#I',
      Stats: [4, 4, 7],
      Talent: '+3.5% run speed',
    },
    {
      Name: 'class_Machinegunner#II',
      Stats: [4, 4, 10],
      Talent: '+7% weapon aim speed',
    },
    {
      Name: 'class_Machinegunner#III',
      Stats: [5, 6, 10],
      Talent: '+100% health restored by medpack',
    },
  ],
  ...
  [
    {
      Name: 'class_AttackerPilot#I',
      Stats: [4, 5, 6],
      Talent: '-5% power of control loss after blackout',
    },
    {
      Name: 'class_AttackerPilot#II',
      Stats: [5, 6, 7],
  ...
  [
    ...
    {
      Name: 'class_Tanker#II',
      Stats: [9, 2, 7],
      Talent: '+5% speed of vehicle repair',
    },
    {
      Name: 'class_Tanker#III',
      Stats: [11, 2, 8],
